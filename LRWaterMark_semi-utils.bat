...
python "main.py" -c config.yaml --input_dir "D:\00-OnedriveRoot\002-mail.sdu.edu.cn\OneDrive - mail.sdu.edu.cn\LightroomOutput\JPEG" --output_dir "D:/00-OnedriveRoot/002-mail.sdu.edu.cn/OneDrive - mail.sdu.edu.cn/LightroomOutput/JPEGAAAwithWaterMark-wechat" --resolution 2155 --quality 90 --shape 2.1 --file_younger_than 7 --force_y_padding True --ignore_file_change_time True
